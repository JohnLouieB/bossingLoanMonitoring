...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('/capital-cash-flow/deductions/server-fee', [CapitalCashFlowController::class, 'storeServerFeeDeduction'])->name('capital-cash-flow.deductions.server-fee');
        Route::delete('/capital-cash-flow/deductions/{capital_deduction}', [CapitalCashFlowController::class, 'destroyDeduction'])->name('capital-cash-flow.deductions.destroy');
    });
});
